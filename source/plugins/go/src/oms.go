...
var sampleLog1 = NetworkFlowLog{
	...
	Verdict:                "FORWARDED",
	DropReason:             "",
	IP:                     serializeToJson(map[string]interface{}{"source": "10.0.190.166", "destination": "192.168.0.213", "ipVersion": "IPv4"}),
	Layer4:                 serializeToJson(map[string]interface{}{"TCP": map[string]interface{}{"source_port": 8080, "destination_port": 60072, "flags": map[string]bool{"ACK": true}}}),
	SourceIdentity:         2,
	SourceClusterName:      "default",
	SourceNamespace:        "default",
	SourcePodName:          "kapinger-good-8468b88556-d75x8",
	SourceWorkloads:        serializeToJson([]string{"reserved:world"}),
	DestinationIdentity:    56017,
	DestinationClusterName: "default",
	DestinationNamespace:   "default",
	DestinationPodName:     "kapinger-good-8468b88556-d75x8",
	DestinationWorkloads:   serializeToJson([]string{"k8s:server=good", "k8s:app=kapinger"}),
	FlowType:               "L3_L4",
	NodeName:               "",
	Layer7:                 "",
	Reply:                  false,
	EventType:              serializeToJson(map[string]int{"type": 4}),
	Service:                serializeToJson(map[string]string{"name": "kapinger-service", "namespace": "default"}),
	TrafficDirection:       "EGRESS",
	TraceObservationPoint:  "TO_ENDPOINT",
	PacketsSent:            0,
	PacketsReceived:        0,
	Policies:               "",
	AdditionalFlowData:     serializeToJson(map[string]int{"bytes": 66}),
}
...
var sampleLog2 = NetworkFlowLog{
	...
	Verdict:                "FORWARDED",
	DropReason:             "",
	IP:                     serializeToJson(map[string]interface{}{"source": "192.168.0.213", "destination": "192.168.0.60", "ipVersion": "IPv4"}),
	Layer4:                 serializeToJson(map[string]interface{}{"TCP": map[string]interface{}{"source_port": 60072, "destination_port": 8080, "flags": map[string]bool{"FIN": true, "ACK": true}}}),
	SourceIdentity:         56017,
	SourceClusterName:      "default",
	SourceNamespace:        "default",
	SourcePodName:          "kapinger-good-8468b88556-d75x8",
	SourceWorkloads:        serializeToJson([]string{"k8s:server=good", "k8s:app=kapinger"}),
	DestinationIdentity:    56017,
	DestinationClusterName: "default",
	DestinationNamespace:   "default",
...
var sampleLog3 = NetworkFlowLog{
	...
	Verdict:                "FORWARDED",
	DropReason:             "",
	IP:                     serializeToJson(map[string]interface{}{"source": "192.168.0.168", "destination": "10.0.190.166", "ipVersion": "IPv4"}),
	Layer4:                 serializeToJson(map[string]interface{}{"TCP": map[string]interface{}{"source_port": 56846, "destination_port": 8080, "flags": map[string]bool{"SYN": true}}}),
	SourceIdentity:         56017,
	SourceClusterName:      "default",
	SourceNamespace:        "default",
	...
	DestinationPodName:     "",
	DestinationWorkloads:   serializeToJson([]string{"reserved:world"}),
	FlowType:               "L3_L4",
	NodeName:               "",
	Layer7:                 "",
	Reply:                  true,
	EventType:              serializeToJson(map[string]int{"type": 4, "sub_type": 3}),
	Service:                serializeToJson(map[string]string{"name": "kapinger-service", "namespace": "default"}),
	TrafficDirection:       "EGRESS",
	...
	PacketsReceived:        0,
	Policies:               "",
	AdditionalFlowData:     serializeToJson(map[string]int{"bytes": 74}),
}
...
var sampleLog4 = NetworkFlowLog{
	...
	IP:                     serializeToJson(map[string]interface{}{"source": "192.168.0.0", "destination": "10.0.190.166", "ipVersion": "IPv4"}),
	Layer4:                 serializeToJson(map[string]interface{}{"TCP": map[string]interface{}{"source_port": 34308, "destination_port": 8080, "flags": map[string]bool{"SYN": true}}}),
	SourceIdentity:         2118,
	SourceClusterName:      "default",
	SourceNamespace:        "default",
	SourcePodName:          "kapinger-bad-7778f55bf8-f5xhd",
	SourceWorkloads:        serializeToJson([]string{"k8s:server=bad", "k8s:app=kapinger"}),
	DestinationIdentity:    2,
	DestinationClusterName: "default",
	DestinationNamespace:   "",
	DestinationPodName:     "",
...
var sampleLog5 = NetworkFlowLog{
	...
	Verdict:                "FORWARDED",
	DropReason:             "",
	IP:                     serializeToJson(map[string]interface{}{"source": "192.168.0.2", "destination": "10.0.190.168", "ipVersion": "IPv4"}),
	Layer4:                 serializeToJson(map[string]interface{}{"TCP": map[string]interface{}{"source_port": 54321, "destination_port": 443, "flags": map[string]bool{"SYN": true}}}),
	SourceIdentity:         4321,
	SourceClusterName:      "default",
	SourceNamespace:        "default",
	SourcePodName:          "layer7-pod",
	SourceWorkloads:        serializeToJson([]string{"k8s:server=layer7", "k8s:app=layer7"}),
	DestinationIdentity:    8765,
	DestinationClusterName: "default",
	DestinationNamespace:   "default",
	DestinationPodName:     "layer7-pod",
	DestinationWorkloads:   serializeToJson([]string{"k8s:server=layer7", "k8s:app=layer7"}),
	FlowType:               "L7",
	NodeName:               "",
	Layer7:                 serializeToJson(map[string]string{"HTTP": `{"method": "GET", "url": "http://example.com"}`}),
	Reply:                  false,
	EventType:              serializeToJson(map[string]int{"type": 4, "sub_type": 3}),
	Service:                serializeToJson(map[string]string{"name": "layer7-service", "namespace": "default"}),
	TrafficDirection:       "EGRESS",
	TraceObservationPoint:  "TO_STACK",
	PacketsSent:            0,
	PacketsReceived:        0,
...
func serializeToJson(data interface{}) string {
	...
	if err != nil {
		Log("Error serializing to JSON: %v", err)
		return ""
	}
